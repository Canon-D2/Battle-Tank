...
pygame.display.set_caption("Đối kháng")

WHITE, BLACK, RED, GREEN, BLUE = (255, 255, 255), (0, 0, 0), (255, 0, 0), (34, 177, 76), (0, 162, 232)
...
GREEN_TANK_IMAGE = pygame.image.load(os.path.join('images', 'tankplayer1.png'))
GREEN_TANK = pygame.transform.rotate(pygame.transform.scale(GREEN_TANK_IMAGE, (TANK_WIDTH, TANK_HEIGHT)), 90)

RED_TANK_IMAGE = pygame.image.load(os.path.join('images', 'tankdich1.png'))
